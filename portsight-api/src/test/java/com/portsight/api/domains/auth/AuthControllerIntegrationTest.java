        ...
        class RegisterTests {
                ...
                void shouldRegisterUserSuccessfully() throws Exception {
                        mockMvc.perform(post("/api/v1/auth/register")
                                        ...
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("newuser@portsight.com"))))
                ...
                void shouldReturn400WhenEmailAlreadyExists() throws Exception {
                        ...
                        mockMvc.perform(post("/api/v1/auth/register")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("duplicate@portsight.com"))))
                                        .andExpect(status().isCreated());
        ...
        class LoginTests {
                ...
                void shouldLoginSuccessfully() throws Exception {
                        ...
                        mockMvc.perform(post("/api/v1/auth/register")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("loginuser@portsight.com"))))
                                        .andExpect(status().isCreated());
                ...
                void shouldReturn400WhenPasswordWrong() throws Exception {
                        ...
                        mockMvc.perform(post("/api/v1/auth/register")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("wrongpass@portsight.com"))))
                                        .andExpect(status().isCreated());
        ...
        class RefreshTests {
                ...
                void shouldRefreshTokenSuccessfully() throws Exception {
                        ...
                        mockMvc.perform(post("/api/v1/auth/register")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("refresh@portsight.com"))))
                                        .andExpect(status().isCreated());
        ...
        class LogoutTests {
                ...
                void shouldLogoutSuccessfully() throws Exception {
                        ...
                        mockMvc.perform(post("/api/v1/auth/register")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("logout@portsight.com"))))
                                        .andExpect(status().isCreated());
                ...
                @Disabled("Logout token invalidation bug - refresh token not deleted from Redis on logout")
                void shouldInvalidateRefreshTokenAfterLogout() throws Exception {
                        // Register + login
                        mockMvc.perform(post("/api/v1/auth/register")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(
                                                        buildRegisterRequest("logoutrefresh@portsight.com"))))
                                        .andExpect(status().isCreated());
